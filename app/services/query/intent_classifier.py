...
def _fallback_classification(question: str) -> dict:
    ...
    security_keywords = [
        "安全", "漏洞", "攻击", "防护", "威胁", "入侵", "渗透", "加密", "认证", "授权", "合规", "审计",
        "监控", "防火墙", "恶意", "风险", "隐私", "权限", "访问控制", "身份", "密码", "证书", "签名", "令牌",
        "会话", "策略", "日志", "告警", "security", "vulnerability", "attack", "defense", "threat", "intrusion",
        "penetration", "encryption", "authentication", "authorization", "firewall", "malware", "exploit", "compliance",
        "audit", "monitoring", "privacy", "permission", "access control", "identity", "password", "certificate",
        "signature", "token", "session", "policy", "log", "alert", "incident", "breach", "phishing", "ransomware",
        "backdoor", "waf", "ids", "ips", "siem", "soc", "iam", "pki", "vpn", "ssl", "tls", "oauth", "saml",
        "jwt", "cors", "csrf", "xss", "sqli", "injection", "gdpr", "hipaa", "pci", "iso27001", "等保", "sox",
        "compliance layer",
    ]
    ai_keywords = [
        "人工智能", "机器学习", "深度学习", "神经网络", "模型", "训练", "推理", "算法", "artificial intelligence",
        "machine learning", "deep learning", "neural network", "model", "training", "inference", "algorithm",
        "transformer", "llm", "gpt", "bert", "nlp", "computer vision", "cv", "cnn", "rnn", "lstm", "gan",
