...
from app.services.resilience import call_with_circuit_breaker, CircuitBreakerOpenError
...
class VectorStoreWithCircuitBreaker:
    ...
    def _bm25_fallback(self, query: str, k: int) -> list[Any]:
        ...
        from app.retrievers.hybrid_retriever import bm25_search
...
def get_circuit_breaker_metrics() -> dict[str, Any]:
    ...
    """
    from app.services.resilience import _BREAKERS
...
def circuit_breaker_status():
    from app.services.circuit_breaker_integration import get_circuit_breaker_metrics
