...
class VectorBaseline:
    ...
    def __init__(self, vectorstore: Chroma, k: int = 5, score_threshold: float | None = None):
...
def create_vector_baseline(vectorstore: Chroma, k: int = 5, score_threshold: float | None = None) -> VectorBaseline:
