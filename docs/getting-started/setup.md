...
1. **[项目结构](../architecture/README.md)** - 了解代码组织
2. **[系统架构](../architecture/overview.md)** - 理解整体设计
3. **[开发流程](../development/workflow.md)** - 学习开发规范
4. **[配置参考](../reference/configuration.md)** - 查看所有配置选项
5. **[API 开发](../development/api-development.md)** - 开始编写代码
