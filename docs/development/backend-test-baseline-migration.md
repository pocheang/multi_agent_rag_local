...
| `tests/agents/test_router_fallback.py` | `app.agents.router_agent` (then retired `agent_config`) | `d1075732`, `54192131`, and `e322be7e` removed compatibility contract | none; typed router owns supported routing | delete-retired-contract | confirm no supported replacement of legacy fallback/config API |
...
| `tests/performance/test_batch_benchmarks.py` | `psutil` | declared in `pyproject.toml`; absent in probe | `benchmark_pdf_processing` | install-dependency | install sync, then collect benchmarks |
| `tests/performance/test_benchmarks.py` | `psutil` | declared in `pyproject.toml`; absent in probe | `benchmark_pdf_processing` | install-dependency | install sync, then collect benchmarks |
...
| `tests/test_agent_scope_filtering.py` | `app.agents.graph_rag_agent`, `vector_rag_agent` exports | `d1075732` deleted wrappers | `app.agents.rag.graph`, `app.agents.rag.vector` | migrate | collect scoped retrieval tests |
...
| `tests/test_graph_rag_optimization.py` | `graph_rag_agent`, `graph_rag_agent_enhanced`, `graph_rag_cache` | `d1075732`/`54192131` deleted wrappers | `app.agents.rag.graph`, `enhanced_graph`, `cache` | migrate | collect split graph-RAG/cache tests |
