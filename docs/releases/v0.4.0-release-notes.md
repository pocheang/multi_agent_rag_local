...
**Documentation**: [docs/features/rag/chinese_nlp_optimization.md](../features/rag/advanced_rag_techniques.md)
...
**Files:**
- `app/ingestion/processing/streaming.py`: True streaming implementation
