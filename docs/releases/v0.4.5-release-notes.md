...
result = run_graph_rag(question="What is LLM?", retrieved_docs=documents)
...
### 技术文档
- [完整优化报告](../operations/performance.md)
- [最终总结](../operations/performance.md)
- [Graph RAG详细文档](../architecture/retrieval-system.md)
- [后续优化建议](../operations/performance.md)
